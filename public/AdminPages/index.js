angular.module('myApp', [
    ...
    // $scope.createUploader = function (buttonId, caontainerId, callback) {
    ...
    //         uptoken_url: 'http://localhost:3000/admin/photos/qnToken',         // Ajax请求uptoken的Url，强烈建议设置（服务端提供）
    //         // uptoken_func: function(file){    // 在需要获取uptoken时，该方法会被调用
    //         //    // do something
    //         //    return uptoken;
    //         // },
    //         get_new_uptoken: false,             // 设置上传文件的时候是否每次都重新获取新的uptoken
    //         //downtoken_url: '/admin/photos/qnToken',
    //         // Ajax请求downToken的Url，私有空间时使用，JS-SDK将向该地址POST文件的key和domain，服务端返回的JSON必须包含url字段，url值为该文件的下载地址
    //         // unique_names: true,              // 默认false，key为文件名。若开启该选项，JS-SDK会为每个文件自动生成key（文件名）
    //         // save_key: true,                  // 默认false。若在服务端生成uptoken的上传策略中指定了sava_key，则开启，SDK在前端将不对key进行任何处理
    //         domain: 'http://ogomt2558.bkt.clouddn.com',     // bucket域名，下载资源时用到，必需
    //         container: caontainerId,             // 上传区域DOM ID，默认是browser_button的父元素
